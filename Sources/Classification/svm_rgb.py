...
np.random.seed(42)
fname = 'logs/svm_rgb.txt'

desc = "Multi class SVM with spooled rgb"
init = time.time()
...
def main():
    ...
    nobjs, splen = 51, 1024
    io_path = '/home/neurobot/Datasets/classification_io/rgb/'
    lg.info('Data path: %s', io_path)
    # header is the same for all
    Xtr, Ytr = prep.extract_mat_content(io_path+'Xtr_rgb.mat', 'io'), prep.extract_mat_content(io_path+'Ytr_rgb.mat', 'io')
            ...
            while cv_flag:
                ...
                if its >= estop_iter:
                    ...
                    if cl.early_stop(loss_arr, estop_acc) or its >= niters:
                        ...
                        confname = '/home/neurobot/Datasets/results/rgb/confmat_' + str(ssize) + '_' + str(regst) + '.mat'
                        yactpred = '/home/neurobot/Datasets/results/rgb/yact_pred_' + str(ssize) + '_' + str(regst) + '.mat'
                        #weights = '/home/neurobot/Datasets/results/rgb/wb_' + str(ssize) + '_' + str(regst) + '.mat'
                        loss_trace = '/home/neurobot/Datasets/results/rgb/loss_' + str(ssize) + '_' + str(regst) + '.mat'
                        train_accs = '/home/neurobot/Datasets/results/rgb/tracc_' + str(ssize) + '_' + str(regst) + '.mat'
                        val_accs = '/home/neurobot/Datasets/results/rgb/vacc_' + str(ssize) + '_' + str(regst) + '.mat'
