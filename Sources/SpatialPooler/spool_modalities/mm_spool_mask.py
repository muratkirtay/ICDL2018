...
def main():
    ...
    bmask_header, smask_header = 'bmask', 'smask'
    ...
    data_path, data_header = bin_path_mask, bmask_header
    sdr_path, sdr_header = spool_mask, smask_header
